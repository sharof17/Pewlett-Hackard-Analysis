...
-- Department Retirees
SELECT e.emp_no, d.dept_name, d.dept_no, e.first_name, e.last_name, de.to_date
-- INTO dept_info
...
-- Creating new table of current employees by joining retirement_info and dept_emp
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
de.to_date
